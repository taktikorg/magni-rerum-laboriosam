# @taktikorg/magni-rerum-laboriosam
A tool for JSON parse and stringify by stream and web worker.

![language](https://img.shields.io/badge/language-JavaScript-orange.svg) 
[![npm version](http://img.shields.io/npm/v/@taktikorg/magni-rerum-laboriosam.svg?style=flat)](https://npmjs.org/package/@taktikorg/magni-rerum-laboriosam) 
[![license](https://img.shields.io/npm/l/@taktikorg/magni-rerum-laboriosam.svg?style=flat)](https://npmjs.org/package/@taktikorg/magni-rerum-laboriosam) 
[![gzip file size](http://img.badgesize.io/yuda-lyu/@taktikorg/magni-rerum-laboriosam/master/dist/@taktikorg/magni-rerum-laboriosam.umd.js.svg?compression=gzip)](https://github.com/taktikorg/magni-rerum-laboriosam)
[![npm download](https://img.shields.io/npm/dt/@taktikorg/magni-rerum-laboriosam.svg)](https://npmjs.org/package/@taktikorg/magni-rerum-laboriosam) 
[![npm download](https://img.shields.io/npm/dm/@taktikorg/magni-rerum-laboriosam.svg)](https://npmjs.org/package/@taktikorg/magni-rerum-laboriosam)
[![jsdelivr download](https://img.shields.io/jsdelivr/npm/hm/@taktikorg/magni-rerum-laboriosam.svg)](https://www.jsdelivr.com/package/npm/@taktikorg/magni-rerum-laboriosam)

## Documentation
To view documentation or get support, visit [docs](https://yuda-lyu.github.io/@taktikorg/magni-rerum-laboriosam/global.html).

## Installation
### Using npm(ES6 module):
> **Note:** @taktikorg/magni-rerum-laboriosam is mainly dependent on `from2` and `jsonparse`.
```alias
npm i @taktikorg/magni-rerum-laboriosam
```

#### Example for samll data:
> **Link:** [[dev source code](https://github.com/taktikorg/magni-rerum-laboriosam/blob/master/g-small.mjs)]
```alias
...
> **Link:** [[dev source code](https://github.com/taktikorg/magni-rerum-laboriosam/blob/master/g-large.mjs)]
```alias
...
#### Example for stream:
> **Link:** [[dev source code](https://github.com/taktikorg/magni-rerum-laboriosam/blob/master/g-stream.mjs)]
```alias
...
> **Note:** @taktikorg/magni-rerum-laboriosam does not dependent on any package.

[Necessary] Add script for @taktikorg/magni-rerum-laboriosam.
```alias

<!-- for basic -->
<script src="https://cdn.jsdelivr.net/npm/@taktikorg/magni-rerum-laboriosam@1.0.21/dist/@taktikorg/magni-rerum-laboriosam.umd.js"></script>

<!-- for web workers -->
<script src="https://cdn.jsdelivr.net/npm/@taktikorg/magni-rerum-laboriosam@1.0.21/dist/@taktikorg/magni-rerum-laboriosam.wk.umd.js"></script>

```

> **stringify and parse for small data:** [ex-small.html](https://yuda-lyu.github.io/@taktikorg/magni-rerum-laboriosam/examples/ex-small.html) [[source code](https://github.com/taktikorg/magni-rerum-laboriosam/blob/master/docs/examples/ex-small.html)]

> **stringifyByStream and parseByStream for small data:** [ex-small-stream.html](https://yuda-lyu.github.io/@taktikorg/magni-rerum-laboriosam/examples/ex-small-stream.html) [[source code](https://github.com/taktikorg/magni-rerum-laboriosam/blob/master/docs/examples/ex-small-stream.html)]

> **stringify and parse for large data:** [ex-large.html](https://yuda-lyu.github.io/@taktikorg/magni-rerum-laboriosam/examples/ex-large.html) [[source code](https://github.com/taktikorg/magni-rerum-laboriosam/blob/master/docs/examples/ex-large.html)]

> **createParseStream:** [ex-stream-createParseStream.html](https://yuda-lyu.github.io/@taktikorg/magni-rerum-laboriosam/examples/ex-stream-createParseStream.html) [[source code](https://github.com/taktikorg/magni-rerum-laboriosam/blob/master/docs/examples/ex-stream-createParseStream.html)] * ReadableStream does not support IE11.

> **createParseStream with filter:** [ex-stream-createParseStreamWithFilter.html](https://yuda-lyu.github.io/@taktikorg/magni-rerum-laboriosam/examples/ex-stream-createParseStreamWithFilter.html) [[source code](https://github.com/taktikorg/magni-rerum-laboriosam/blob/master/docs/examples/ex-stream-createParseStreamWithFilter.html)]

> **createStringifyStream:** [ex-stream-createStringifyStream.html](https://yuda-lyu.github.io/@taktikorg/magni-rerum-laboriosam/examples/ex-stream-createStringifyStream.html) [[source code](https://github.com/taktikorg/magni-rerum-laboriosam/blob/master/docs/examples/ex-stream-createStringifyStream.html)] * WritableStream does not support IE11 and Firefox.

> **stringify and parse for large data in web worker:** [ex-large-webworker.html](https://yuda-lyu.github.io/@taktikorg/magni-rerum-laboriosam/examples/ex-large-webworker.html) [[source code](https://github.com/taktikorg/magni-rerum-laboriosam/blob/master/docs/examples/ex-large-webworker.html)] * WebWorkers(from blob) does not support IE11.
```alias

console.log('WebWorkers(from blob) does not support IE11')

let json = window['@taktikorg/magni-rerum-laboriosam']
console.log(json)
